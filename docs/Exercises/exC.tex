...
\end{prooftree}
The transition follows from unfolding the constant $K_{n_1,\ldots} \overset{\text{def}}{=} \enc P\{^{n_1}/_{x_1},\ldots\}\cne$ and applying the IH to the body; derivation depth strictly decreases at each unfolding step.
